...
namespace Nova
{
	...
	unsigned int IndexedMesh::m_drawCallCount = 0;
	...
	////////////////// indexed mesh ////////////////////
	IndexedMesh::IndexedMesh(Vertex* vertices, GLuint vCount, const std::vector<unsigned int> indices)
	{
		...
		glNamedBufferStorage(m_buffers[0], vCount * sizeof(vertices[0]), vertices, 0);
		...
		std::cout << "tex offset: " << offsetof(Vertex, tex) << std::endl;
		std::cout << "vertex size: " << sizeof(vertices[0])  << std::endl;
		std::cout << "\nindex size: " << sizeof(indices[0])   << std::endl;
		std::cout << "index amount: " << indices.size() << std::endl;
*/
		// Setup the formats
		glVertexArrayAttribFormat(m_vao, posLocation, 3, GL_FLOAT, GL_FALSE, offsetof(Vertex, pos)); // 0
		glVertexArrayAttribFormat(m_vao, colLocation, 4, GL_FLOAT, GL_FALSE, offsetof(Vertex, col)); // 12
	...
	void IndexedMesh::ResetDrawCalls()
	{
		m_drawCallCount = 0;
	}

	unsigned int IndexedMesh::GetDrawCallCount()
	{
